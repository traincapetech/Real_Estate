        ...
        */}
        <section className="relative h-[92vh] w-full flex items-center justify-center overflow-hidden bg-slate-950">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
            ...
            >
              <h1 className="text-5xl md:text-8xl font-black text-white mb-6 leading-[1.1] tracking-tighter uppercase drop-shadow-2xl">
                FIND YOUR HOUSE <br />
              ...
              <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-6 py-2 mb-8 shadow-xl">
                <span className="text-amber-400 font-bold tracking-[0.2em] uppercase text-xs">
                  ✦ BOLD INDIA GROUP LANDMARK AVAILABLE ✦
                </span>
              </div>
        ...
        <section className="py-24 px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                { name: 'Luxury Villas', subtext: '120+ Listings', icon: <HomeIcon /> },
                { name: 'Modern Flats', subtext: '450+ Listings', icon: <Zap /> },
                { name: 'Commercial', subtext: '85+ Listings', icon: <Shield /> },
                { name: 'Plots/Land', subtext: '200+ Listings', icon: <MapPin /> },
                { name: 'Delhi NCR Farm Houses', subtext: 'Ganagadham Natural', icon: <HomeIcon /> },
              ].map((cat) => (
                <motion.div
                  key={cat.name}
                  whileHover={{ y: -12 }}
                ...
                >
                  ...
                  <h3 className="font-black text-slate-900 text-lg mb-2 leading-tight">{cat.name}</h3>
                  <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">{cat.subtext}</p>
                </motion.div>
              ))}
            </div>
          </div>
