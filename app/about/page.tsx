...
const values = [
  { 
    title: "Transparency", 
    desc: "No hidden costs, no complex jargon. Just honest real estate advice from start to finish." 
  },
  { 
    title: "Expertise", 
    desc: "Our agents possess deep knowledge of the Delhi NCR, Mumbai, and Bangalore luxury markets." 
  },
  { 
    title: "Commitment", 
    desc: "We stay with you from the very first viewing to the final registration and beyond." 
  }
];
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {values.map((v, i) => (
              <motion.div 
                ...
                className="bg-white p-8 md:p-12 rounded-[2rem] shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
              >
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
        className="mx-6 mb-24 max-w-7xl lg:mx-auto"
      >
        <div className="relative overflow-hidden rounded-[3rem] bg-slate-950 py-20 px-8 md:px-16 border border-slate-800 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              <span className="text-amber-400 font-bold tracking-[0.3em] text-xs uppercase mb-6 block">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-tight tracking-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">
                  With Bold India Group.
                </span>
              </h2>
              <p className="text-slate-400 text-lg max-w-lg mx-auto lg:mx-0">
                Experience real estate the way it was meant to be—seamless, exclusive, and tailored to your vision.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-auto">
              <Link 
                href="/properties" 
                className="group relative inline-flex items-center justify-center bg-amber-400 text-slate-950 px-10 py-5 rounded-2xl font-black transition-all hover:bg-amber-300 hover:shadow-[0_0_30px_rgba(251,191,36,0.3)] active:scale-95 shadow-xl"
              >
              ...
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center border-2 border-slate-700 text-white px-10 py-5 rounded-2xl font-black transition-all hover:bg-white hover:text-slate-950 hover:border-white uppercase tracking-widest text-sm"
              >
                Book a Call
              </Link>
            </div>
