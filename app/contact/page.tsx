...
export default function Contact() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-slate-900 overflow-x-hidden">
      ...
      <section className="pt-24 pb-16 px-4 md:px-6 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto text-center">
          <motion.span 
            ...
            className="text-amber-600 font-bold tracking-[0.2em] text-xs uppercase mb-4 block"
          >
            Get In Touch
          </motion.span>
          <motion.h1 
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-8">
                  ...
                  {[
                    { icon: <Phone size={24} />, title: "Call Us", details: ["+91 99999 88888", "+91 11 4050 6070"] },
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-slate-950 rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl"
              >
            ...
            >
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit" 
                  className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-slate-800 transition-all shadow-xl shadow-slate-200"
                >
                  Send Inquiry
      ...
      >
        <div className="max-w-7xl mx-auto h-[450px] bg-slate-100 rounded-[3rem] overflow-hidden relative border-8 border-white shadow-2xl group">
          <div className="absolute inset-0 flex items-center justify-center bg-slate-200 transition-colors group-hover:bg-slate-150">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-xs mt-2 italic font-medium">Gurugram HQ Office • DLF Cyber City</p>
            </div>
          </div>
        </div>
      </motion.section>
