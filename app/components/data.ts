...
},
{
  ...
  beds: 2,
  baths: 2,
  image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1200',
  description: 'A contemporary 2 BHK apartment in Saket featuring spacious rooms, modern modular kitchen, and round-the-clock security. Located close to the metro station and major shopping malls.',
  amenities: ['Power Backup', 'Gym', 'Metro Connectivity', 'Security'],
  status: 'Ready to Move',
  furnishing: 'Semi Furnished',
  parking: '1 Covered Parking',
},
{
  ...
  baths: 3,
  image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200',
  description: 'Luxury 3 BHK flat situated in a prime residential area of Vasant Kunj. Offers Italian marble flooring, expansive balconies, private terrace access, and dedicated parking.',
  amenities: ['Gated Community', 'Intercom Facility', 'Children Play Area', 'Lush Green Parks'],
  status: 'Ready to Move',
  furnishing: 'Fully Furnished',
  parking: '2 Covered Parking',
},
{
  ...
  baths: 5,
  image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1200',
  description: 'An expansive modern farmhouse in Noida featuring private palm groves, a swimming pool, and lush green lawns. A perfect retreat within reach of the city.',
  amenities: ['Swimming Pool', 'Private Lawn', 'Servant Quarters', '24/7 Security'],
  status: 'Ready to Move',
  furnishing: 'Fully Furnished',
  parking: '4 Car Parking',
},
{
  id: 19,
  title: 'Vrindavan Dham Farm House',
  ...
  beds: 3,
  baths: 3,
  image: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?auto=format&fit=crop&w=1200',
  description: 'A serene and peaceful farmhouse in Vrindavan, designed with traditional Indian courtyard architecture. Perfect for spiritual rejuvenation and quiet living.',
  amenities: ['Courtyard', 'Private Temple', 'Organic Garden', 'Power Backup'],
  status: 'Ready to Move',
  furnishing: 'Semi Furnished',
...
{
  id: 20,
  title: 'Ganga View Retreat Farm House',
  location: 'Garh Ganga, Garh Mukteshwar',
  price: '40L - 2.5 Cr',
  type: 'Farm House',
  sqft: 4200,
  beds: 4,
  ...
  description: 'A beautiful riverside farmhouse in Garh Mukteshwar, offering breathtaking views of the holy Ganga River. Features massive verandas, organic farming land, and modern amenities.',
  amenities: ['River View', 'Organic Farm Land', 'Veranda', 'Boating Deck Access'],
  status: 'Ready to Move',
  furnishing: 'Fully Furnished',
  parking: '3 Car Parking',
}
